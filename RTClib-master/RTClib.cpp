...
uint16_t RTC_DS3231::readTemperature(void)
{
uint8_t temp1,temp2;
temp1 = read_i2c_register(DS3231_ADDRESS, DS3231_TEMP1REG);
temp2 = read_i2c_register(DS3231_ADDRESS, DS3231_TEMP2REG);
return (temp1<<2 | temp2 >>6 & 0X3FF); // 10 bits
}

void RTC_DS3231::readTemperature(char* result)
{
  sprintf(result,"%d.%d",read_i2c_register(DS3231_ADDRESS, DS3231_TEMP1REG) ,(read_i2c_register(DS3231_ADDRESS, DS3231_TEMP2REG)>>6)*25);
  return ;
}